<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="GenericProject.ForgotPassword" %>
...
<body class="auth-body-bg">
                                            ...
                                            <div class="text-center">
                                                <div>
                                                    <a href="index.html" class="logo">
                                                        <img src="design/assets/loginpageimage/logologin.png" style="width: 50%;" alt="logo">
                                                    </a>
                                                </div>
                                                <h4 class="font-size-18 mt-4">Welcome Back !</h4>
                                                <p class="text-muted">Forgot password with U-TEL.</p>
                                            </div>
                                            <div class="p-2 mt-5">
                                                ...
                                                <div class="mt-4 text-center">
                                                    <a href="javascript:void(0);" style="width: 100%;" onclick="forgotpassword();" class="btn btn-primary w-md waves-effect waves-light">Recover Password</a>
                                                </div>
                                                <div class="mt-4 text-center">
                                                    <a href="Login.aspx" class="text-muted"><b><i class="fa fa fa-backward"></i><span style="margin-left: 5px;">Back to login</span></b></a>
                                                </div>
                                                <div class="mt-4 text-center">
                                                    <p>© All Right Reserved By <b><a href="https://virtuzo.in/" target="_blank">ENK Technologies Pvt. Ltd.</a></b></p>
                                                </div>
                                            </div>
    ...
    <script src="jsMethod/forgotpassword.js"></script>
    <script>
