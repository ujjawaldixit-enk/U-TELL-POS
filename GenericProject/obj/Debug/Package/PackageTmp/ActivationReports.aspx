<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ActivationReports.aspx.cs" Inherits="GenericProject.ActivationReports" %>
                                ...
                                <asp:GridView ID="grdOrderReport" runat="server" ShowHeaderWhenEmpty="True" AllowSorting="True" GridLines="Both" HeaderStyle-Font-Bold="true" CellPadding="0" CellSpacing="0" EnableViewState="True" AutoGenerateColumns="false" ClientIDMode="Static" class="table table-striped table-bordered table-hover">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Activation Date">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblActivationDate" Text='<%# Eval("ActivationDate") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Plan">
                                         ...
                                         <asp:TemplateField HeaderText="Number Of Days">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblNODS" Text='<%# Eval("NODS") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
