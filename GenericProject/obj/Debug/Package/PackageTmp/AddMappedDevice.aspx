<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddMappedDevice.aspx.cs" Inherits="GenericProject.AddMappedDevice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid" style="margin-bottom: -70px;">
                <div class="col-xl-12">
                    <div class="row">
                        <div class="card" style="padding: 20px; min-height: 500PX; width: 100% !important;">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="margin-top: 10px;">
                                    <label>Mapping Type<span style="color: red;">*</span></label>
                                    <asp:DropDownList ID="ddlMapUnmap" runat="server" Style="height: 43px; border-radius: 0px;" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlMapUnmap_SelectedIndexChanged">
                                        <asp:ListItem Value="1">Mapping</asp:ListItem>
                                        <asp:ListItem Value="2">UnMapping</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-3" style="margin-top: 10px; display: none">
                                    <label>Request Type<small class="txt-color-red"> * </small></label>
                                    <asp:DropDownList ID="ddlDeviceMappingType" runat="server" Style="height: 42px;" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlDeviceMappingType_SelectedIndexChanged">
                                        <asp:ListItem Value="2">Bulk Map/Unmap</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-3" runat="server" id="CountryDiv" style="margin-top: 10px;">
                                    ...
                                    <select id="countries" is="ms-dropdown" onchange="SelectCountry();" runat="server">
                                        ...
                                        <option value="435" data-image-css="flag us" data-title="United States">USA</option>
                                ...
                                <div class="col-md-3" style="margin-top: 10px;" runat="server" id="PlanDiv">
                                    <label>Plan<span style="color: red;">*</span></label>
                                    <select class="form-control" runat="server" id="ddlPlanList" style="height: 42px; border-radius: 0px;" onchange="SelectPlan();">
                                    </select>
                                </div>
                                <div class="col-md-3" runat="server" id="NumberOfDaysDiv" style="margin-top: 10px;">
                                    <label class="control-label">Number Of Days<small class="txt-color-red">*</small></label>
                                    <select class="form-control" runat="server" id="ddlDays" style="height: 42px; border-radius: 0px;" onchange="SelectNumberOfDays();">
                                ...
                                <div class="col-md-3" style="margin-top: 10px; display: none;" runat="server" id="BulkDeviceNumber">
                                    <label>Bulk Upload<span style="color: red;">*</span></label>
                                    <asp:FileUpload ID="fuBulkUpload" Style="height: 42px; border-radius: 0px;" runat="server" CssClass="form-control" ClientIDMode="Static" />
                                </div>

                            </div>
                            <div class="row" style="margin-top: 10px;" runat="server" id="RepeterDiv" visible="false">
                                <div class="col-md-12" id="RPTDiv" style="height: 300px; overflow-y: scroll;">
                                    <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                        <asp:Repeater ID="RepeaterDeviceMapping" runat="server" OnItemCommand="RepeaterDeviceMapping_ItemCommand">
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lblStatus" Text='<%# Eval("IsValid") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:Label runat="server" ID="lblreason" Text='<%# Eval("Reason") %>' />
                                                    </td>
                                                    <td>
                                                        <asp:LinkButton ID="lbtnRemove" runat="server" CommandArgument='<%# Container.ItemIndex %>' CommandName="Delete">Remove</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                            ...
                            <div class="row" style="margin-top: 30px;" runat="server">
                                <div class="col-md-12" style="margin-top: 20px; display: flex;">
                                    <asp:Button ID="btnUpload" runat="server" Text="Upload" CssClass="btn btn-primary" OnClick="btnUpload_Click" Style="display: none;" />
                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnSubmit_Click" Style="display: none;" />
                                    <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn btn-danger" OnClick="btnReset_Click" Style="margin-left: 5px;" />
                                    <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btn btn-primary" OnClick="btnBack_Click" Style="margin-left: 5px;" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function SelectCountry() {
            ...
            if (CountryID != "0") {
                var CountryName = $("#ContentPlaceHolder1_countries option:selected").text();
                $.ajax({
                    url: 'AddMappedDevice.aspx/GetPlanUsingCountryID',
                ...
                $("#ContentPlaceHolder1_ddlPlanList").empty();
                $("#ContentPlaceHolder1_PlanDiv").hide();
            }
            $("#ContentPlaceHolder1_btnUpload").hide();
            $("#ContentPlaceHolder1_BulkDeviceNumber").hide();
    ...
    <script type="text/javascript">
        function SelectPlan() {
            ...
            debugger;
            if (PlanID != "0") {
                var PlanName = $("#ContentPlaceHolder1_ddlPlanList option:selected").text();
                $.ajax({
                    url: 'AddMappedDevice.aspx/GetPlanDetailsByID',
                    data: '{PlanID: "' + PlanID + '",PlanName: "' + PlanName + '" }',
                    contentType: 'application/json',
                    dataType: 'json',
                    type: 'POST',
                    success: function (result) {
                        alert(Number(result.d.PlanValidity));
    ...
    <script type="text/javascript">
        function SelectNumberOfDays() {
            ...
            $.ajax({
                url: 'AddMappedDevice.aspx/CalPaybleAmountByDays',
