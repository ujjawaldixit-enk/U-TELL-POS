<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Activation.aspx.cs" Inherits="GenericProject.Activation" %>
            ...
            <div class="container-fluid">
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" runat="server" id="CustomerfNameDiv" style="margin-top: 10px; display: none;">
                            <label class="control-label">Customer Name<small class="txt-color-red">*</small></label>
                            <asp:TextBox ID="txtCustomerName" autocomplete="off" Style="height: 40px;" placeholder="First Name" runat="server" ClientIDMode="Static" class="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-3" runat="server" id="EmailDiv" style="margin-top: 10px; display: none;">
                            <label class="control-label">Customer Email Id <small class="txt-color-red">*</small></label>
                            <asp:TextBox ID="txtEmail" placeholder="EmailId" Style="height: 40px;" runat="server" ClientIDMode="Static" autocomplete="off" class="form-control"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-12" style="margin-top: 20px; display: flex;">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Activate Now" Style="height: 40px; display: none" OnClick="btnSubmit_Click" CssClass="btn btn-success" OnClientClick="if (!validateControlsAct()) { return false;};" />
    ...
    <script type="text/javascript">
        function validateControlsAct() {
            ...
            if (!filter.test(email.value)) {
                alert('Email address is invalid, Please enter a valid email id.');
                email.focus;
                return false;
            }
            return true;
