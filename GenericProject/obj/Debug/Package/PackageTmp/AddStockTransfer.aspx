<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddStockTransfer.aspx.cs" Inherits="GenericProject.AddStockTransfer" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Network</label>
                                            <asp:DropDownList runat="server" ID="ddlActionType" CssClass="dropdown DropContent" AutoPostBack="true" OnSelectedIndexChanged="ddlActionType_SelectedIndexChanged">
                                                <asp:ListItem Value="1">Single Transfer</asp:ListItem>
                                                <asp:ListItem Value="2">Bulk Transfer</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Network</label>
                                    ...
                                    <div class="row" runat="server" id="SingleUploadDiv" style="margin-top: 20px;">
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox runat="server" ID="txtDeviceNumber" MaxLength="25" CssClass="form-control" placeholder="Device Number"></asp:TextBox>
                                        </div>
                                        <div class="col-md-3" style="margin-top: 29px;">
                                ...
                                <div class="col-md-12" style="margin-top: 30px;">
                                    ...
                                    <a href="StockTransfer.aspx" id="A1" runat="server" class="dt-button create-new btn btn-primary">Device Transfer List</a>
                                </div>
                            </div>
                        </div>
                    </div>
